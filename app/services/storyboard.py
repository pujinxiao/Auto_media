...
def _build_character_section(character_info: Optional[dict]) -> str:
    """Build character reference section for the storyboard prompt."""
...
async def parse_script_to_storyboard(
    ...
    """
    character_section = _build_character_section(character_info)
